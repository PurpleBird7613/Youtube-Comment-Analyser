...
load_dotenv()
# Getting The Video Comments Using YT API Call
class YouTubeCommentsTool:
        ...
        while True:
            ...
            if response.status_code == 200:
                ...
                for item in data.get("items", []):
                    ...
                    commented = item["snippet"]["topLevelComment"]["snippet"]["textOriginal"]
                    
                    comment = {"user": comment_user,"comment": commented}
    ...
    def validate_video_id(self, video_id):
        ...
        response = requests.get(f"https://www.googleapis.com/youtube/v3/videos?part=id&id={video_id}&key=AIzaSyAkTMjN4TpLyy1R7sapYHEAS1nOTojlVME")
